    ...
    >
      ...
      <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-4 sm:space-y-5">
          <div>
            <p className="text-[0.65rem] uppercase tracking-[0.24em] text-slate-400 sm:text-sm">
            ...
            <p className="mt-3 flex items-center gap-2 text-sm text-slate-300">
              ...
              Chance of rain: {formatPercentage(data.current.precipitation_probability)}
            </p>
          </div>

          <div className="flex items-end gap-3 sm:gap-4">
            <span className="text-4xl font-semibold tracking-tight text-white sm:text-6xl md:text-7xl">
              {currentTemp}
            </span>
        ...
        <div className="relative flex min-h-[112px] items-center justify-center lg:min-h-[180px]">
          <div className="absolute h-32 w-32 rounded-full bg-sky-400/10 blur-3xl sm:h-56 sm:w-56" />
          <WeatherIcon
